...
var RxLitElement = /*#__PURE__*/function (_LitElement) {
  function RxLitElement() {
    ...
    _this = _callSuper(this, RxLitElement, arguments);
    _this.$connected = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
    _RxLitElement_firstUpdate.set(_this, void 0);
    _this.$ = {};
    return _this;
  }
  _inherits(RxLitElement, _LitElement);
  return _createClass(RxLitElement, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      _superPropGet(RxLitElement, "connectedCallback", this, 3)([]);
      this.$connected.next(true);
    }
  }, {
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _superPropGet(RxLitElement, "disconnectedCallback", this, 3)([]);
      this.$connected.next(false);
    }
  }, {
    key: "firstUpdated",
    value: function firstUpdated() {
      Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__classPrivateFieldSet"])(this, _RxLitElement_firstUpdate, true, "f");
    }
  }, {
    key: "updated",
    value: function updated(changedProperties) {
      if (!Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__classPrivateFieldGet"])(this, _RxLitElement_firstUpdate, "f")) {
      ...
      Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__classPrivateFieldSet"])(this, _RxLitElement_firstUpdate, false, "f");
    }
  }, {
    key: "fireEvent",
...
var LitElement = /*#__PURE__*/function (_UpdatingElement) {
  ...
  return _createClass(LitElement, [{
     ...
     */
    function initialize() {
      _superPropGet(LitElement, "initialize", this, 3)([]);
    ...
    value: function _getUniqueStyles() {
      ...
      if (Array.isArray(userStyles)) {
        ...
        // previous styles.
        var _addStyles = function addStyles(styles, set) {
          return styles.reduceRight(function (set, s) {
            return (
              // Note: On IE set.add() does not return the set
              Array.isArray(s) ? _addStyles(s, set) : (set.add(s), set)
            );
          }, set);
        };
        // Array.from does not work on Set in IE, otherwise return
        // Array.from(addStyles(userStyles, new Set<CSSResult>())).reverse()
        var set = _addStyles(userStyles, new Set());
        var styles = [];
...
var PropertyCommitter = /*#__PURE__*/function (_AttributeCommitter) {
  ...
  return _createClass(PropertyCommitter, [{
    ...
    value: function _getValue() {
      ...
      return _superPropGet(PropertyCommitter, "_getValue", this, 3)([]);
    }
  }, {
    key: "commit",
    value: function commit() {
...
var SVGTemplateResult = /*#__PURE__*/function (_TemplateResult) {
  function SVGTemplateResult() {
    ...
    return _callSuper(this, SVGTemplateResult, arguments);
  }
  _inherits(SVGTemplateResult, _TemplateResult);
  return _createClass(SVGTemplateResult, [{
    key: "getHTML",
    value: function getHTML() {
      return "<svg>".concat(_superPropGet(SVGTemplateResult, "getHTML", this, 3)([]), "</svg>");
    }
  }, {
    key: "getTemplateElement",
    value: function getTemplateElement() {
      var template = _superPropGet(SVGTemplateResult, "getTemplateElement", this, 3)([]);
...
//# sourceMappingURL=LEGACY-vendors~drawer~push-state-hydejack-9.2.1.js.map